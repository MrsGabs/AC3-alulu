...
module.exports = (app)=>{
    app.post('/atividades', async(req,res)=>{
        ...
        var gravar = await new atividades({
            ...
            usuario:dados.id
            //na model é instruções e no forms é orientações
        }).save()
...
app.post("/alterar", async(req, res)=>{
    //armazenar as informações recebidasd do forms
    var dados = req.body
    console.log(dados)
    //visualizar os dados
    // res.send(dados)

    //atualizar o doc selecionado - tudo que tem underline vem da collection
